...
*Defined in [ext/error.ts:46](https://github.com/polkadot-js/common/blob/f0aebfc/packages/util/src/ext/error.ts#L46)*
...
*Defined in [ext/error.ts:35](https://github.com/polkadot-js/common/blob/f0aebfc/packages/util/src/ext/error.ts#L35)*
...
*Defined in [ext/error.ts:37](https://github.com/polkadot-js/common/blob/f0aebfc/packages/util/src/ext/error.ts#L37)*
...
*Defined in [ext/error.ts:40](https://github.com/polkadot-js/common/blob/f0aebfc/packages/util/src/ext/error.ts#L40)*
...
*Defined in [ext/error.ts:43](https://github.com/polkadot-js/common/blob/f0aebfc/packages/util/src/ext/error.ts#L43)*
...
*Defined in [ext/error.ts:63](https://github.com/polkadot-js/common/blob/f0aebfc/packages/util/src/ext/error.ts#L63)*

###  ASSERT

• **ASSERT**: *number* =  -90009

*Defined in [ext/error.ts:64](https://github.com/polkadot-js/common/blob/f0aebfc/packages/util/src/ext/error.ts#L64)*

###  INVALID_JSONRPC

• **INVALID_JSONRPC**: *number* =  -99998

*Defined in [ext/error.ts:66](https://github.com/polkadot-js/common/blob/f0aebfc/packages/util/src/ext/error.ts#L66)*

###  METHOD_NOT_FOUND

• **METHOD_NOT_FOUND**: *number* =  -32601

*Defined in [ext/error.ts:67](https://github.com/polkadot-js/common/blob/f0aebfc/packages/util/src/ext/error.ts#L67)*

###  UNKNOWN

• **UNKNOWN**: *number*

*Defined in [ext/error.ts:65](https://github.com/polkadot-js/common/blob/f0aebfc/packages/util/src/ext/error.ts#L65)*